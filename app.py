...
# Dirección ngrok TCP (no HTTP) correctamente separada
MIKROTIK_API_HOST = os.environ.get('MIKROTIK_API_HOST', '0.tcp.ngrok.io')
USERNAME = os.environ.get('MIKROTIK_USERNAME', 'admin')
PASSWORD = os.environ.get('MIKROTIK_PASSWORD', '1234567890')
API_PORT = int(os.environ.get('MIKROTIK_API_PORT', 13268))  # El puerto TCP correcto
